...
export default function Footer() {
  return (
    <footer className="bg-[#07090f] pt-14 pb-6">
        ...
        {/* Bottom bar */}
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="sr-only">LinkedIn de Tresbit</span>
            </a>
            <a
            ...
            >
              ...
              <span className="sr-only">GitHub de Tresbit</span>
            </a>
            <a
            ...
            >
              ...
              <span className="sr-only">Instagram de Tresbit</span>
            </a>
          </div>
        </div>
      </div>
