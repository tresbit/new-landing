          ...
          {visibleIndices.map((offset) => {
            ...
            return (
              <motion.div
                key={absIndex}
                className={cn(
                  "absolute aspect-[3/4] w-[220px] md:w-[280px] rounded-2xl border-t border-white/20 bg-neutral-900 shadow-2xl cursor-pointer",
                ...
                transition={{
                  ...
                  z: { type: "spring", stiffness: 300, damping: 30, mass: 1 },
                  scale: { type: "spring", stiffness: 450, damping: 18, mass: 1 },
                  rotateY: { type: "spring", stiffness: 300, damping: 30, mass: 1 },
        ...
        <div className="mx-auto mt-10 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
          <div className="flex flex-1 flex-col items-center text-center md:items-start md:text-left h-28 justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                {activeItem.meta && (
                  <span className="text-xs font-medium uppercase tracking-wider text-[#5ba8d8]">
                    {activeItem.meta}
                  </span>
                )}
                ...
                {activeItem.description && (
                  <p className="max-w-md text-neutral-400 text-sm leading-relaxed">{activeItem.description}</p>
                )}
              </motion.div>
            </AnimatePresence>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            {activeItem.href && (
              <Link
                ...
                className="group flex items-center gap-2 rounded-full bg-[#286291] px-5 py-3 text-sm font-semibold text-white transition-transform hover:scale-105 active:scale-95 hover:bg-[#286291]/90 cursor-pointer"
              >
                Consultar
